...
Questrace vendors `flutter_math_fork` 0.7.4 because the application requires a small compatibility change that is not available in the hosted package used by the original project.
