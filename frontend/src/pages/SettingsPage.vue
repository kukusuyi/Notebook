...
<div class="page-shell settings-page">
 ...
 <el-tabs v-model="active" class="settings-tabs">
  ...
  <el-tab-pane label="关于与账户" name="about"><section class="paper-card panel"><h3>题迹 Notebook</h3><p>2.0 · 让每一道错题都有收获</p><p class="meta-text">题目和图片保存在当前电脑。保持电脑在线，即可从同一局域网的手机访问。</p><template v-if="settings"><el-form-item label="APK 下载地址"><el-input v-model="settings.download_url" placeholder="可选"/></el-form-item><el-button :loading="busy" @click="save">保存下载地址</el-button></template><el-divider/><el-button @click="logout">退出当前账户</el-button></section></el-tab-pane>
 </el-tabs>
</div>
</template>
